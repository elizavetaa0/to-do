...
export class ItemPresenter {
	...
	constructor(
        ...
        // создаем экземпляр формы для создания нового дела - каждый экземпляр новый экземпляр eventemitera
        init() {
            ...
            this.todoForm.on('submit', this.handleSubmitForm.bind(this)); // устанавливаем обработчик события на форму
